...
DEFAULT_PRINT_DATE = False
DEFAULT_PRINT_HOSTNAME = False

# http://blog.mathieu-leplatre.info/colored-output-in-console-with-python.html
BLACK, RED, GREEN, YELLOW, BLUE, MAGENTA, CYAN, WHITE = range(8)


def __has_colors(stream, allow_piping=True):
...
def print_log(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
...
def header(msg, max_width=80, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Header."""
...
def print_color(msg, color=WHITE, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print message with color prefix."""
    print_log(colorText(msg, color), print_date, print_hostname)


def print_color_prefix(prefix, color, msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print message with color prefix."""
    print_log(colorText(prefix, color) + msg, print_date, print_hostname)


def info(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Info Level."""
    print_color_prefix("INFO: ", YELLOW, msg, print_date, print_hostname)


def warn(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Warning Level."""
    print_color_prefix("WARN: ", YELLOW, msg, print_date, print_hostname)


def error(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Error Level."""
    print_color_prefix("ERROR: ", RED, msg, print_date, print_hostname)


def failed(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Failed Level."""
    print_color_prefix("FAILED: ", RED, msg, print_date, print_hostname)


def verbose(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Verbose Level."""
...
def task(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print Task Level."""
    print_color_prefix("TASK: ", BLUE, msg, print_date, print_hostname)


def skipping(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print skipping Level."""
    print_color_prefix("SKIPPING: ", CYAN, msg, print_date, print_hostname)


def running(msg, print_date=DEFAULT_PRINT_DATE, print_hostname=DEFAULT_PRINT_HOSTNAME):
    """Print running Level."""
